...
<head>
    ...
    <title>Admin Panel pallab.me</title>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="text-center p-20 upgrade-btn">
                            <a href="logout.php"
                                class="btn btn-warning text-white mt-4">Log Out</a>
                        </li>
                    </ul>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <div class="text-end upgrade-btn">
                            <a href="logout.php"
                                class="btn btn-danger d-none d-md-inline-block text-white">Log Out</a>
                        </div>
                    </div>
                </div>
            </div>
